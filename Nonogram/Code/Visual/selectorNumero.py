...
class Selector:
    ...
    def __init__(self, x: int, y: int, max: int):
        ...
        self.botonrestar = Boton(
            "<", (x, y), self.__tam, self.__colores, self.restar)
        self.botonsumar = Boton(
            ">", (x+100, y), self.__tam, self.__colores, self.sumar)
    ...
    def dibujartexto(self, ventana):
        texto_renderizado = self.fuente.render(
            str(self.__valor), True, (255, 255, 255))
